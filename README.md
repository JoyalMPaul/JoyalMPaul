...
🎓 Current Junior studying CS at Binghamton University <br> 
🛠️ Skills: Python | C# | SQL | Java | C++ | C | JS | HTML | CSS | GIT <br>
...
👥 Participating in clubs: StackHacks, ACM, ColorStack, Game Development Group

💼 Open to internships, contributing to open source projects, part-time jobs, micro-internships, research, and volunteering <br> 
